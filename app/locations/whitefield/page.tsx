...
export const metadata: Metadata = {
  title: "Visa Consultant in whitefield, Bengaluru",
  description:
    "TrailTreeTrip provides tourist visa, business visa, family visit visa, passport, flight, hotel, travel insurance and holiday package assistance for customers in whitefield, Bengaluru.",

  keywords: [
    "visa consultant whitefield",
    "travel agency whitefield",
    "passport services whitefield",
    "visa consultant near whitefield",
    "travel agency near whitefield",
    "Schengen visa consultant whitefield",
    "Singapore visa whitefield",
    "Dubai visa whitefield",
    "flight booking whitefield",
    "holiday packages whitefield",
  ],

  alternates: {
    canonical: "/locations/whitefield",
  },

  openGraph: {
    title: "Visa Consultant in whitefield | TrailTreeTrip",
    description:
      "Professional visa, passport and travel assistance for customers in whitefield, Bengaluru.",
    url: "https://www.trailtreetrip.com/locations/whitefield",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 1200,
        alt: "TrailTreeTrip Visa Consultant in whitefield",
      },
    ],
  },
};
...
const faqs = [
  {
    question: "Where is TrailTreeTrip located near whitefield?",
    answer:
      "TrailTreeTrip is located at 11th Floor, No. 32/2, Prestige Tech Platina, Innov8, 34/1, Kadubeesanahalli, Bengaluru, Karnataka 560087, conveniently accessible from whitefield.",
  },
  {
    question: "Do you provide visa assistance for customers in whitefield?",
    answer:
      "Yes. Customers from whitefield and nearby areas can contact TrailTreeTrip for tourist, business and family visit visa assistance, passport support and complete travel services.",
  },
  {
  ...
  "@graph": [
    {
      ...
      description:
        "TrailTreeTrip provides visa, passport, flight, hotel, travel insurance and holiday package assistance for customers in whitefield and nearby Bengaluru areas.",
          ...
          <div className="container-shell grid min-h-[650px] items-center gap-12 py-16 lg:grid-cols-[1.05fr_.95fr]">
            <div>
              ...
              <h1 className="mt-5 max-w-3xl font-serif text-5xl font-bold leading-tight text-slate-950 sm:text-6xl">
                Visa Consultant and Travel Agency in whitefield
              </h1>
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600">
                ...
                holiday packages for customers in whitefield, Bengaluru.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                ...
                <a
                  href={`https://wa.me/${whatsapp}?text=${encodeURIComponent(
                    "Hello TrailTreeTrip, I need visa or travel assistance in whitefield.",
                  )}`}
                  target="_blank"
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2rem] bg-slate-950 p-8 text-white shadow-2xl sm:p-10">
                <span className="text-xs font-extrabold uppercase tracking-[0.2em] text-amber-400">
                  TrailTreeTrip – Serving whitefield
                </span>
        ...
        <section className="section-space">
          <div className="container-shell">
            <div className="section-heading">
              ...
              <h2>
                Visa, passport and travel services for whitefield
              </h2>
          ...
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="heading-large mt-4">
                Convenient assistance for whitefield travellers
              </h2>

              <p className="mt-5 leading-8 text-slate-600">
                Customers from whitefield can conveniently access
            ...
            <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-lg">
              <iframe
                ...
                title="TrailTreeTrip office near whitefield"
                className="w-full"
              />
            </div>
          </div>
            ...
            <div>
              ...
              <div className="mt-8 space-y-4 text-slate-200">
                ...
                <p className="flex items-center gap-3">
                  ...
                  Serving whitefield from our Kadubeesanahalli office
                </p>
              </div>
            </div>
