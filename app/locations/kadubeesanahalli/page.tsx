...
export const metadata: Metadata = {
  title: "Visa Consultant in Kadubeesanahalli, Bengaluru",
  description:
    "TrailTreeTrip provides tourist visa, business visa, family visit visa, passport, flight, hotel, travel insurance and holiday package assistance in Kadubeesanahalli, Bengaluru.",

  keywords: [
    "visa consultant Kadubeesanahalli",
    "travel agency Kadubeesanahalli",
    "passport services Kadubeesanahalli",
    "visa consultant near Marathahalli",
    "travel agency near Bellandur",
    "Schengen visa consultant Kadubeesanahalli",
    "Singapore visa Kadubeesanahalli",
    "Dubai visa Kadubeesanahalli",
    "flight booking Kadubeesanahalli",
    "holiday packages Kadubeesanahalli",
  ],

  alternates: {
    canonical: "/locations/kadubeesanahalli",
  },

  openGraph: {
    title: "Visa Consultant in Kadubeesanahalli | TrailTreeTrip",
    description:
      "Professional visa, passport and travel assistance from TrailTreeTrip in Kadubeesanahalli, Bengaluru.",
    url: "https://www.trailtreetrip.com/locations/kadubeesanahalli",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 1200,
        alt: "TrailTreeTrip Visa Consultant in Kadubeesanahalli",
      },
    ],
  },
};
...
const faqs = [
  {
    question: "Where is TrailTreeTrip located in Kadubeesanahalli?",
    answer:
      "TrailTreeTrip is located at 11th Floor, No. 32/2, Prestige Tech Platina, Innov8, 34/1, Kadubeesanahalli, Bengaluru, Karnataka 560087.",
  },
  {
    question: "Do you provide visa assistance near Marathahalli and Bellandur?",
    answer:
      "Yes. Customers from Kadubeesanahalli, Marathahalli, Bellandur, Devarabisanahalli and nearby Bengaluru areas can contact TrailTreeTrip for visa and travel assistance.",
  },
  {
  ...
  "@graph": [
    {
      ...
      description:
        "TrailTreeTrip provides visa, passport, flight, hotel, travel insurance and holiday package assistance in Kadubeesanahalli, Bengaluru.",
...
export default function KadubeesanahalliPage() {
          ...
          <div className="container-shell grid min-h-[650px] items-center gap-12 py-16 lg:grid-cols-[1.05fr_.95fr]">
            <div>
              ...
              <h1 className="mt-5 max-w-3xl font-serif text-5xl font-bold leading-tight text-slate-950 sm:text-6xl">
                Visa Consultant and Travel Agency in Kadubeesanahalli
              </h1>
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600">
                ...
                holiday packages from Kadubeesanahalli, Bengaluru.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                ...
                <a
                  href={`https://wa.me/${whatsapp}?text=${encodeURIComponent(
                    "Hello TrailTreeTrip, I need visa or travel assistance in Kadubeesanahalli.",
                  )}`}
                  target="_blank"
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[2rem] bg-slate-950 p-8 text-white shadow-2xl sm:p-10">
                <span className="text-xs font-extrabold uppercase tracking-[0.2em] text-amber-400">
                  TrailTreeTrip Kadubeesanahalli
                </span>
        ...
        <section className="section-space">
          <div className="container-shell">
            <div className="section-heading">
              ...
              <h2>
                Visa, passport and travel services in Kadubeesanahalli
              </h2>
          ...
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 leading-8 text-slate-600">
                Our office in Kadubeesanahalli is convenient for customers
            ...
            <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-lg">
              <iframe
                ...
                title="TrailTreeTrip Kadubeesanahalli location"
                className="w-full"
              />
            </div>
          </div>
