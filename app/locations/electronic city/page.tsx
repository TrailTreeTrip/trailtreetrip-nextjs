...
export const metadata: Metadata = {
  title: "Visa Consultant in Electronic city, Bengaluru",
  description:
    "TrailTreeTrip provides tourist visa, business visa, family visit visa, passport, flight, hotel, travel insurance and holiday package assistance in electronic city, Bengaluru.",

  keywords: [
    "visa consultant electronic city",
    "travel agency electronic city",
    "passport services electronic city",
    "visa consultant near Marathahalli",
    "travel agency near Bellandur",
    "Schengen visa consultant electronic city",
    "Singapore visa electronic city",
    "Dubai visa electronic city",
    "flight booking electronic city",
    "holiday packages electronic city",
  ],

  alternates: {
    canonical: "/locations/electronic city",
  },

  openGraph: {
    title: "Visa Consultant in electronic city | TrailTreeTrip",
    description:
      "Professional visa, passport and travel assistance from TrailTreeTrip in electronic city, Bengaluru.",
    url: "https://www.trailtreetrip.com/locations/electronic city",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 1200,
        alt: "TrailTreeTrip Visa Consultant in electronic city",
      },
    ],
  },
};
...
const faqs = [
  {
    question: "Where is TrailTreeTrip located in electronic city?",
    answer:
      "TrailTreeTrip is located at 11th Floor, No. 32/2, Prestige Tech Platina, Innov8, 34/1, electronic city, Bengaluru, Karnataka 560087.",
  },
  {
    question: "Do you provide visa assistance near Marathahalli and Bellandur?",
    answer:
      "Yes. Customers from electronic city, Marathahalli, Bellandur, Devarabisanahalli and nearby Bengaluru areas can contact TrailTreeTrip for visa and travel assistance.",
  },
  {
  ...
  "@graph": [
    {
      ...
      description:
        "TrailTreeTrip provides visa, passport, flight, hotel, travel insurance and holiday package assistance in electronic city, Bengaluru.",
      ...
      address: {
        "@type": "PostalAddress",
        streetAddress:
          "11th Floor, No. 32/2, Prestige Tech Platina, Innov8, 34/1, electronic city",
          ...
          <div className="container-shell grid min-h-[650px] items-center gap-12 py-16 lg:grid-cols-[1.05fr_.95fr]">
            <div>
              ...
              <h1 className="mt-5 max-w-3xl font-serif text-5xl font-bold leading-tight text-slate-950 sm:text-6xl">
                Visa Consultant and Travel Agency in electronic city
              </h1>
              ...
              <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600">
                ...
                holiday packages from electronic city, Bengaluru.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                ...
                <a
                  href={`https://wa.me/${whatsapp}?text=${encodeURIComponent(
                    "Hello TrailTreeTrip, I need visa or travel assistance in electronic city.",
                  )}`}
                  target="_blank"
        ...
        <section className="section-space">
          <div className="container-shell">
            <div className="section-heading">
              ...
              <h2>
                Visa, passport and travel services in electronic city
              </h2>
          ...
          <div className="container-shell grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="heading-large mt-4">
                Convenient assistance for East Bengaluru travellers
              </h2>

              <p className="mt-5 leading-8 text-slate-600">
                Our office in electronic city is convenient for customers
                working or residing near Marathahalli, Bellandur,
                Devarabisanahalli, Mahadevapura and surrounding technology
                corridors.
              </p>
            ...
            <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-lg">
              <iframe
                src="https://www.google.com/maps?q=TrailTreeTrip%20electronic city%20Bengaluru&output=embed"
                width="100%"
                height="460"
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="TrailTreeTrip electronic city location"
                className="w-full"
              />
            </div>
          </div>
            ...
            <div>
              ...
              <div className="mt-8 space-y-5 text-slate-700">
                <p className="flex gap-3">
                  ...
                  34/1, electronic city, Bengaluru, Karnataka 560087
                </p>
